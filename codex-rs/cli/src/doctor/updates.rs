...
const GITHUB_LATEST_RELEASE_URL: &str =
    "https://api.github.com/repos/dopaemon/codex-termux/releases/latest";
...
fn update_action_label(context: &InstallContext) -> &'static str {
    match &context.method {
        InstallMethod::Npm => "npm install -g @dopaemon/codex-termux",
        InstallMethod::Bun => "bun install -g @dopaemon/codex-termux",
