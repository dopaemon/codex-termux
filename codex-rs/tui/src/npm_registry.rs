...
pub(crate) const PACKAGE_URL: &str = "https://registry.npmjs.org/@dopaemon%2fcodex-termux";
    ...
    fn version_json(version: &str) -> serde_json::Value {
        serde_json::json!({
            "dist": {
                ...
                "tarball": format!("https://registry.npmjs.org/@dopaemon/codex-termux/-/dopaemon-codex-termux-{version}.tgz"),
            }
        })
    }
