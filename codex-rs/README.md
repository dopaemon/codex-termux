...
```shell
npm i -g @dopaemon/codex-termux
codex
```

You can also install via Homebrew (`brew install --cask codex`) or download a platform-specific release directly from [GitHub Releases](https://github.com/dopaemon/codex-termux/releases).
